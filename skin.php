...
if (imagesy($im) > 32) {
    ...
    imagedestroy($mi);
    // CREATE THE SMALL CROPPED VERSION
    $cropped = imagecreatetruecolor(16, 32);
    imagecopyresized($cropped, $av,0, 0, 35, 35, 16, 32, 48, 96); 

}

//header('Content-type: image/png');
imagepng($cropped, "test_out.png");
imagedestroy($im);
imagedestroy($av);
